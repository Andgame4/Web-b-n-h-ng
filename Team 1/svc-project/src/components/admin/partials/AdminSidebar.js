...
const AdminSidebar = (props) => {
  ...
  return (
    <Fragment>
      <div
        style={{ boxShadow: "1px 1px 8px 0.2px #aaaaaa", padding: "10px" }}
        id="sidebar"
        className="hidden md:block sticky top-0 left-0  md:w-3/12 lg:w-2/12 
        sidebarShadow bg-white text-gray-600"
      >
        <Link to='/'>
          <div
          ...
          >
            ...
            <span className="hover:text-gray-800">Trang chủ</span>
          </div>
        </Link>
        ...
        <Link to="/orders">
          ...
          >
            ...
            <span className="hover:text-gray-800">Đặt hàng</span>
          </div>
        </Link>
        <hr className="border-b border-gray-200" />
        <Link to="/users">
